...
function audioMetadataArtistStyle(color: string) {
  return css`
    font-size: 22px;
    font-weight: 700;
    margin: 0px;
...
function audioMetadataTrackStyle(color: string) {
  return css`
    font-size: 14px;
    margin: 0;
    color: ${color};
...
function playIconContainerStyle(bgColor: string) {
  return css`
...
function controlsStyle (bgColor: string) {
  return css`
  height: 140px;
  background-color: ${bgColor};
  display: flex;
